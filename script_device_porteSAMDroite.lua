...
local porte={}
    porte['ouverte']	= '$Porte Fenetre SAM Droite ouverte'       -- Nom de l'interupteur d'ouverture
    porte['fermee']	    = '$Porte Fenetre SAM Droite ferme'         -- Nom de l'interupteur fermeture
    porte['casse']      = '$Porte Fenetre SAM Droite casse'         -- Nom de l'interupteur en cqs de casse du module
    porte['virtuel']	= 'Porte Fenetre SAM Droite'               	-- Nom de l'interupteur virtuel
