...
local porte={}
    porte['ouverte']	= '$Porte Fenetre CH1 Droite ouverte'       -- Nom de l'interupteur d'ouverture
    porte['fermee']	    = '$Porte Fenetre CH1 Droite ferme'         -- Nom de l'interupteur fermeture
    porte['casse']      = '$Porte Fenetre CH1 Droite casse'         -- Nom de l'interupteur en cqs de casse du module
    porte['virtuel']	= 'Porte Fenetre CH1 Droite'               	-- Nom de l'interupteur virtuel
