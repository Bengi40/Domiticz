...
local porte={}
    porte['ouverte']	= '$Porte Fenetre Cuisine Droite ouverte'       -- Nom de l'interupteur d'ouverture
    porte['fermee']	    = '$Porte Fenetre Cuisine Droite ferme'         -- Nom de l'interupteur fermeture
    porte['casse']      = '$Porte Fenetre Cuisine Droite casse'         -- Nom de l'interupteur en cqs de casse du module
    porte['virtuel']	= 'Porte Fenetre Cuisine Droite'               	-- Nom de l'interupteur virtuel
